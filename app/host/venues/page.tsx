      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Manage the locations where you host classes and events</p>
          </div>
          <button
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {v.city}, {v.state}, {v.country} {v.postalCode}
                    </p>
                  </div>
                  <span className={`text-xs px-2 py-1 rounded-full ${v.status === 'PUBLISHED' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}>
                    {v.status}
                  </span>
                </div>
