...
const resources = {
  en: {
    common: {
      ...
      join: {
        ...
        subtitle: 'Whether you want to teach or learn, we have a place for you!',
        becomeHost: 'Become A Host',
        hostDescription: 'Share your passion for dance! Teach classes, host events, and build your community.',
        hostBenefit1: 'Set your own schedule and rates',
        hostBenefit2: 'Earn money doing what you love',
        hostBenefit3: 'Reach students worldwide',
        hostBenefit4: 'Professional tools and support',
        startTeaching: 'Start Teaching',
        joinAsStudent: 'Join as Student',
        studentDescription: 'Start your dance journey today! Learn from expert instructors and connect with fellow dancers.',
        studentBenefit1: 'Access to diverse dance styles',
        studentBenefit2: 'Join a vibrant community',
        studentBenefit3: 'Flexible class schedules',
        studentBenefit4: 'First class free trial',
        registerNow: 'Register Now',
        trusted: 'Trusted by thousands of dancers and instructors worldwide',
  ...
  ko: {
    common: {
      ...
      join: {
        title: '우리 커뮤니티에 참여하세요',
        subtitle: '가르치고 싶든 배우고 싶든, 당신을 위한 자리가 있습니다!',
        becomeHost: '호스트 되기',
        hostDescription: '댄스에 대한 열정을 공유하세요! 수업을 가르치고, 이벤트를 주최하고, 커뮤니티를 구축하세요.',
        hostBenefit1: '자신만의 일정과 요금 설정',
        hostBenefit2: '사랑하는 일을 하며 수익 창출',
        hostBenefit3: '전 세계 학생들에게 도달',
        hostBenefit4: '전문 도구 및 지원',
        startTeaching: '강의 시작',
        joinAsStudent: '학생으로 참여',
        studentDescription: '오늘 댄스 여정을 시작하세요! 전문 강사로부터 배우고 동료 댄서들과 연결하세요.',
        studentBenefit1: '다양한 댄스 스타일 접근',
        studentBenefit2: '활기찬 커뮤니티 참여',
        studentBenefit3: '유연한 수업 일정',
        studentBenefit4: '첫 수업 무료 체험',
        registerNow: '지금 등록',
        trusted: '전 세계 수천 명의 댄서와 강사들이 신뢰합니다',
        verifiedInstructors: '검증된 강사',
  ...
  vi: {
    common: {
      ...
      join: {
        ...
        subtitle: 'Dù bạn muốn dạy hay học, chúng tôi đều có chỗ cho bạn!',
        becomeHost: 'Trở thành Host',
        hostDescription: 'Chia sẻ niềm đam mê khiêu vũ của bạn! Dạy các lớp học, tổ chức sự kiện và xây dựng cộng đồng của bạn.',
        hostBenefit1: 'Đặt lịch trình và giá của riêng bạn',
        hostBenefit2: 'Kiếm tiền từ điều bạn yêu thích',
        hostBenefit3: 'Tiếp cận học viên trên toàn thế giới',
        hostBenefit4: 'Công cụ và hỗ trợ chuyên nghiệp',
        startTeaching: 'Bắt đầu Dạy',
        joinAsStudent: 'Tham Gia Với Tư Cách Học Viên',
        studentDescription: 'Bắt đầu hành trình khiêu vũ của bạn hôm nay! Học từ các giảng viên chuyên nghiệp và kết nối với các vũ công khác.',
        studentBenefit1: 'Tiếp cận các phong cách khiêu vũ đa dạng',
        studentBenefit2: 'Tham gia cộng đồng sôi động',
        studentBenefit3: 'Lịch học linh hoạt',
        studentBenefit4: 'Lớp học đầu tiên miễn phí',
        registerNow: 'Đăng Ký Ngay',
        trusted: 'Được tin tưởng bởi hàng nghìn vũ công và giảng viên trên toàn thế giới',
        verifiedInstructors: 'Giảng viên đã xác minh',
  ...
  es: {
    common: {
      ...
      join: {
        ...
        subtitle: '¡Ya sea que quieras enseñar o aprender, tenemos un lugar para ti!',
        becomeHost: 'Conviértete en Host',
        hostDescription: '¡Comparte tu pasión por la danza! Enseña clases, organiza eventos y construye tu comunidad.',
        hostBenefit1: 'Establece tu propio horario y tarifas',
        hostBenefit2: 'Gana dinero haciendo lo que amas',
        hostBenefit3: 'Alcanza estudiantes en todo el mundo',
        hostBenefit4: 'Herramientas profesionales y soporte',
        startTeaching: 'Comenzar a Enseñar',
        joinAsStudent: 'Unirse como Estudiante',
        studentDescription: '¡Comienza tu viaje de danza hoy! Aprende de instructores expertos y conéctate con otros bailarines.',
        studentBenefit1: 'Acceso a diversos estilos de danza',
        studentBenefit2: 'Únete a una comunidad vibrante',
        studentBenefit3: 'Horarios de clase flexibles',
        studentBenefit4: 'Primera clase de prueba gratis',
        registerNow: 'Registrarse Ahora',
        trusted: 'Confiado por miles de bailarines e instructores en todo el mundo',
        verifiedInstructors: 'Instructores Verificados',
